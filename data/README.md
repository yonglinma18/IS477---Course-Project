...
Because some of the original raw datasets exceed GitHub’s size limitations, we store the full raw files locally and document all download details here for reproducibility.
...
- File format: CSV
- Download date: 2025-11-16
- Description: Model-based estimates for chronic disease, health outcomes, and health behaviors at county and community levels.
- Notes:
...
## Reproducibility
Anyone accessing this repository can re-download the original datasets using the links above.  
